...
// !!! 스프링에서는 maven 으로 commons-codec-1.11.jar 파일을 다운받아 사용하도록 한다. !!!
// https://search.maven.org/ 에 가서 검색어로 commons-codec 을 입력한다.
// commons-codec 을 선택한후 숫자 12 를 클릭하여 최신버전인 1.11 을 클릭하여 
/*
    <dependency>
