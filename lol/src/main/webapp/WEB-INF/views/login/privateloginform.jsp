...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#btnPrivateLogin").click(function() {
			// alert("dtd");
	   		 func_Login();
	...
	function func_Login() {
		 ...
		 var frm = document.privateLoginFrm;
		 frm.action = "<%=ctxPath%>/privateLoginEnd.we";
		 frm.method = "POST";
		 frm.submit();
...
<body>
	<div class="body">
		<form name="privateLoginFrm">
		<div class="grad"></div>
		<div class="header">
			<div><span>개인회원<br/>로그인</span></div>
		</div>
		<br>	
		<div class="login">
				...
				<input type="button" value="Login" id="btnPrivateLogin"/>
				<input type="button" value="Register" id="btnPrivateRegister" /><br/><br/>
				 <% 
						if(flag == true) { %> 
