...
function initialize() {
	...
	navigator.geolocation.getCurrentPosition(function(position) {
		...
		var mapOptions = { 
	        zoom : 14, // 기본 확대율
	      center : new google.maps.LatLng(37.567957, 126.983134),   // 지도 중앙 위치
...
/* 		var storeArr = [
		...
		var storeArr = ['37.566011', '126.982621','1'];
...
function setMarkers(targetmap, storeArr){
	...
	for(var i=0; i < storeArr.length; i++) {
		...
		markerArr[i] = new google.maps.Marker({  
			...
			map: targetmap,
		//	icon : image,              // 마커 이미지
			title : '시험',          // 위에서 정의한 "${store.storeName}" 임
			zIndex : Number('1')  // 위에서 정의한 "${storevo.zindex}" 임.  Number() 함수를 꼭 사용해야 함을 잊지 말자.
		});
...
<div align="center">
<div id="googleMap" style="width: 800px; height: 500px; border: 0px solid red;">

</div>
<table>
	<tr>
		<th>
			<input type="text" style="display: block;margin-bottom: 10px;width: 300px;" placeholder="Enter your name">
		</th>
		<th rowspan="3">
			<textarea rows="6" cols="30" placeholder="Enter Message"></textarea>
		</th>
	</tr>
	<tr>
		<td>
			<input type="text" style="display: block;margin-bottom: 10px;width: 300px;" placeholder="Enter email address">
		</td>
	</tr>
	<tr>
		<td>
		<input type="text" style="display: block;margin-bottom: 10px;width: 300px;" placeholder="Enter Subject">
		</td>
	</tr>
	<tr>
		<td>
		...
		<td align="right">
			<button type="button" style="display: inline-block;">send message</button>
		</td>
	</tr>
</table>
</div>